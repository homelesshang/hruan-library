  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        ...
        <li v-for="t in allFamousWorks" :key="t">
          {{ t }}
        </li>
      </ul>
...
const modernAuthors = computed(() => {
  ...
  return authors.filter(a => a.birthYear > 1850)
})

// Activity 3: Get all famous works
const allFamousWorks = computed(() => {
  // TODO: CODE TO GET ALL FAMOUS WORKS HERE
  return authors.flatMap(a => a.famousWorks.map(w => w.title))
})

// Activity 4: Find author by name
const orwell = computed(() => {
  // TODO: CODE TO FIND AUTHOR BY NAME HERE
  return authors.find(a => a.name === 'George Orwell')
})
